...
namespace PonavljanjePosleKursa1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "PonavljanjePosleKursa1", Version = "v1" });
            });
            ...
            services.AddAutoMapper(typeof(TelefonProfile));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "PonavljanjePosleKursa1 v1"));
            }
